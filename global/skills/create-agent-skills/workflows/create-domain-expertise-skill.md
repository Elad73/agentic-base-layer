...
## Step 11: Document in create-plans (optional)

If create-plans is installed, you can update `~/.claude/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] (Optional) Referenced in create-plans domain inference table
